...
import { Shield, Globe, TrendingUp, ArrowRight, CheckCircle2, Circle } from 'lucide-react';
      ...
      <div className="landing-container">
        ...
        <section id="use-cases" className="features">
          <div className="section-header">
            <h2>Use Cases</h2>
            <p>Tailored compliance intelligence for every global movement profile.</p>
          </div>
          ...
          >
            <motion.div variants={itemVariants} className="bento-item glass-card large">
              ...
              <p>Master the 90/180-day rule with a smart rolling window engine that accurately predicts your safe re-entry dates.</p>
            </motion.div>
            ...
            <motion.div variants={itemVariants} className="bento-item glass-card">
              ...
              <p>A unified dashboard to monitor visa-free limits and entry counts for 150+ countries simultaneously.</p>
            </motion.div>
        ...
        <section className="comparison-section">
          <div className="section-header comparison-header">
            <h2>Traditional residency tracking <span>don't cut it anymore</span></h2>
            <p>Nomad Tax is changing the game in the residency world and traditional tools don't even come close.</p>
          </div>
          ...
          <div className="comparison-grid">
            <div className="method-column">
              <div className="method-list">
                {[
                  ...
                  <motion.div 
                    key={i} 
                    className="method-item traditional"
                    initial={{ opacity: 0, x: -20 }}
                    whileInView={{ opacity: 1, x: 0 }}
                    transition={{ delay: i * 0.1 }}
                  >
                    <Circle size={18} className="icon-fail" />
                    <span>{item}</span>
                  </motion.div>
                ))}
              </div>
            ...
            <div className="method-column">
              <motion.div 
                className="nomad-card-advantage"
                initial={{ opacity: 0, y: 30 }}
                whileInView={{ opacity: 1, y: 0 }}
            ...
            <div className="faq-left">
              ...
              >
                ...
                <div className="faq-contact">
                  Have more questions? Reach out to our team via email - <a href="mailto:team@nomadtax.io">team@nomadtax.io</a>
                </div>
              </motion.div>
            </div>
